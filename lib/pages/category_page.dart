...
//  void _choiceAction(){
//    print('ready choice........................');
//    if(typeController.text.toString()==null){
//      showDialog(
//        context: context,
//        builder: (context)=>AlertDialog(title: Text('EditText is null'),)
//      );
...
//    try{
//      var data = {'name':typeText};
//      Response response = await Dio().get("http://172.123.100.162:8085/getTestResp",queryParameters: data);
//      //Response response = await Dio().get("https://www.easy-mock.com/mock/5c60131a4bed3a6342711498/baixing/dabaojian?name=lolita");
//      return response.data;
//    }catch(e){
//      return print(e);
...
//
//      Response response = await Dio()
//          .post("http://172.123.100.162:8085/getPostResp",
